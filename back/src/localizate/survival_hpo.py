...
def run_activity_survival_hpo(
    *,
    ...
    resolved_baseline = rolling_baseline_json or (MODELS_DIR / "activity_survival_rolling_backtest.json")
    resolved_metrics = metrics_json or (MODELS_DIR / "activity_survival_hpo.json")
    resolved_report = report_md or (DOCS_MODELING_DIR / "activity_survival_hpo.md")
    resolved_checkpoint = checkpoint_json or (MODELS_DIR / "activity_survival_hpo_checkpoint.json")
