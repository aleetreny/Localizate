...
def run_canonical_robustness_check(
    *,
    ...
    resolved_report_md = report_md or (DOCS_MODELING_DIR / "survival_canonical_robustness.md")
    resolved_report_json = report_json or (MODELS_DIR / "survival_canonical_robustness.json")
