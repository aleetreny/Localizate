...
def run_activity_survival_rolling_backtest(
    *,
    ...
    resolved_comparison = comparison_metrics_json or (MODELS_DIR / "survival_activity_canonical_metrics.json")
    resolved_metrics = metrics_json or (MODELS_DIR / "activity_survival_rolling_backtest.json")
    resolved_report = report_md or (DOCS_MODELING_DIR / "activity_survival_rolling_backtest.md")
