...
def validate_survival_feature_frame(
    *,
    ...
    resolved_metrics = metrics_json or (MODELS_DIR / "survival_feature_validation.json")
    resolved_report = report_md or (DOCS_MODELING_DIR / "survival_feature_validation.md")
