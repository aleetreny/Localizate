...
def attach_renta_features(
    ...
    *,
    ...
    section = (
        renta_madrid[renta_madrid["granularity"] == "section"].reindex(columns=section_columns)
        .drop_duplicates()
        .rename(
            columns={
...
def write_section_socioeconomic_outputs(
    ...
    *,
    ...
    resolved_report_md = report_md_path or (DOCS_DATA_DIR / "section_socioeconomic_panel.md")
