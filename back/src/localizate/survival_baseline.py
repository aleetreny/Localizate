...
def train_and_score_survival_baseline(
    *,
    ...
    resolved_metrics = metrics_json or (MODELS_DIR / "survival_baseline_metrics.json")
    resolved_report = report_md or (DOCS_MODELING_DIR / "survival_baseline.md")
...
def build_feature_frame(
    ...
    *,
    ...
    frame["district_panel_locales_open_start"] = np.log1p(pd.to_numeric(dataset.get("district_panel_locales_open_start"), errors="coerce"))
    frame["district_panel_locales_closed_start"] = np.log1p(pd.to_numeric(dataset.get("district_panel_locales_closed_start"), errors="coerce"))
    frame["district_panel_unemployment_rate_start"] = pd.to_numeric(dataset.get("district_panel_unemployment_rate_start"), errors="coerce")
    frame["district_panel_mean_age_start"] = pd.to_numeric(dataset.get("district_panel_mean_age_start"), errors="coerce")
    frame["district_panel_dependency_index_start"] = pd.to_numeric(dataset.get("district_panel_dependency_index_start"), errors="coerce")
    frame["district_panel_migrant_share_start"] = pd.to_numeric(dataset.get("district_panel_migrant_share_start"), errors="coerce")
    frame["district_panel_density_start"] = pd.to_numeric(dataset.get("district_panel_density_start"), errors="coerce")
    frame["district_iguala_vulnerability_global_start"] = pd.to_numeric(dataset.get("district_iguala_vulnerability_global_start"), errors="coerce")
    frame["district_iguala_bienestar_start"] = pd.to_numeric(dataset.get("district_iguala_bienestar_start"), errors="coerce")
    frame["district_iguala_medio_ambiente_start"] = pd.to_numeric(dataset.get("district_iguala_medio_ambiente_start"), errors="coerce")
    frame["district_iguala_educacion_start"] = pd.to_numeric(dataset.get("district_iguala_educacion_start"), errors="coerce")
    frame["district_iguala_economia_start"] = pd.to_numeric(dataset.get("district_iguala_economia_start"), errors="coerce")
    frame["district_iguala_salud_start"] = pd.to_numeric(dataset.get("district_iguala_salud_start"), errors="coerce")
