...
def run_modeling_readiness_check(
    *,
    ...
    resolved_baseline_metrics = baseline_metrics_json or (MODELS_DIR / "survival_baseline_metrics.json")
    resolved_canonical_metrics = canonical_metrics_json or (MODELS_DIR / "survival_canonical_metrics.json")
    resolved_robustness_json = robustness_json or (MODELS_DIR / "survival_canonical_robustness.json")
    resolved_geospatial_manifest = geospatial_manifest_csv or (DATA_DIR / "processed" / "censo_geospatial_manifest.csv")
    resolved_report_md = report_md or (DOCS_MODELING_DIR / "modeling_readiness.md")
    resolved_report_json = report_json or (MODELS_DIR / "modeling_readiness.json")
