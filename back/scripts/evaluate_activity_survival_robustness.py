...
def main() -> int:
    ...
    result = run_canonical_robustness_check(
        ...
        map_export_csv=PROJECT_ROOT / "storage" / "data" / "exports" / "activity_survival_map_export.csv",
        canonical_metrics_json=PROJECT_ROOT / "storage" / "models" / "survival_activity_canonical_metrics.json",
        report_md=PROJECT_ROOT / "docs" / "modeling" / "survival_activity_canonical_robustness.md",
        report_json=PROJECT_ROOT / "storage" / "models" / "survival_activity_canonical_robustness.json",
