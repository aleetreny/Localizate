...
from .paths import DATA_DIR, DOCS_DIR, PROJECT_ROOT, RAW_DATA_DIR
...
def build_zone_category_survival_analysis(
    *,
    ...
    resolved_taxonomy_md = taxonomy_md or (DOCS_DIR / "activity_taxonomy_web.md")
    ...
    resolved_stats_json = stats_json or (PROJECT_ROOT / "models" / "zone_category_survival_stats.json")
    resolved_report_md = report_md or (DOCS_DIR / "zone_category_survival.md")
