...
def run_activity_survival_cox_ablation(
    *,
    ...
    resolved_hpo = hpo_json or (PROJECT_ROOT / "models" / "activity_survival_hpo.json")
    resolved_metrics = metrics_json or (PROJECT_ROOT / "models" / "activity_survival_cox_ablation.json")
    resolved_report = report_md or (DOCS_DIR / "activity_survival_cox_ablation.md")
