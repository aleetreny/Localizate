...
def train_activity_horizon_logistic_models(
    *,
    ...
    resolved_metrics = metrics_json or (PROJECT_ROOT / "models" / "activity_horizon_logistic_metrics.json")
    resolved_report = report_md or (DOCS_DIR / "activity_horizon_logistic.md")
