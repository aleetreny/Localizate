...
def build_panel_indicator_yearly_features(
    *,
    ...
    resolved_panel = panel_csv or (PROJECT_ROOT / "data" / "external" / "panel_indicadores_2020_2025.csv")
...
def build_iguala_yearly_features(
    *,
    ...
    resolved_iguala = iguala_xlsx or (PROJECT_ROOT / "data" / "external" / "iguala_global_distritos.xlsx")
