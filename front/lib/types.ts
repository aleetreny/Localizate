...
export type MapSharedArtifacts = Omit<FrontendArtifacts, "hexes">;

export type MapHexArtifacts = {
  meta: {
    generated_at: string;
    hex_size: "small" | "medium" | "large";
...
export type OpportunitySectionIndexArtifacts = {
  meta: {
    generated_at: string;
  };
...
export type OpportunitySectionGeometryProperties = Pick<
  OpportunitySection,
  | "section_key"
  | "district_code"
  | "district_name"
...
export type OpportunitySectionFeature = {
  ...
  properties: OpportunitySectionGeometryProperties;
};
