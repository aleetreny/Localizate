...
export type OpportunityFieldBenchmark = {
  ...
  districtMean: number | null;
  barrioMean: number | null;
...
const FIELD_PERCENTILE_MODE: Record<OpportunityBenchmarkField, PercentileMode> = {
  ...
  metro_station_count_500m_start: "ascending",
  metro_station_count_1000m_start: "ascending",
...
function buildFieldBenchmark({
  ...
  return {
    ...
    cityMean: mean(cityValues),
    districtMean: mean(districtValues),
    barrioMean: mean(barrioValues),
