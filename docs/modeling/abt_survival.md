...
ABT por local con cierre observado tanto por desaparición del `id_local` como por primer cambio robusto `single-single` de division, tratado como cierre estructural.
...
- Cierre por desaparición del local: 0
- Censurados: 184,503
...
## Cambios de division más frecuentes tratados como cierre
