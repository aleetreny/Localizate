...
- Moda [Retail especializado / Moda y complementos] -> epigrafes=1, source_rows=548,449, investable=True
- Bar restaurante [Hosteleria / Bar y cafeteria] -> epigrafes=1, source_rows=544,326, investable=True
- Cafeteria [Hosteleria / Bar y cafeteria] -> epigrafes=1, source_rows=408,293, investable=True
- Logistica y movilidad [Servicios / Logistica y movilidad] -> epigrafes=11, source_rows=406,649, investable=True
- Oficina y administracion [Servicios / Servicios profesionales] -> epigrafes=1, source_rows=353,507, investable=True
- Restaurante [Hosteleria / Restauracion] -> epigrafes=1, source_rows=346,007, investable=True
- Fruteria [Alimentacion / Alimentacion fresca] -> epigrafes=2, source_rows=338,847, investable=True
- Tienda de alimentacion [Alimentacion / Supermercado y conveniencia] -> epigrafes=1, source_rows=337,657, investable=True
- Supermercado [Alimentacion / Supermercado y conveniencia] -> epigrafes=1, source_rows=294,889, investable=True
...
- Calzado [Retail especializado / Moda y complementos] -> epigrafes=1, source_rows=140,390, investable=True
- Inmobiliaria [Servicios / Servicios profesionales] -> epigrafes=1, source_rows=139,222, investable=True
- Pasteleria y reposteria [Alimentacion / Panaderia y pasteleria] -> epigrafes=3, source_rows=139,177, investable=True
- Charcuteria [Alimentacion / Alimentacion fresca] -> epigrafes=1, source_rows=137,633, investable=True
- Clinica dental [Salud y bienestar / Clinicas y consultas] -> epigrafes=1, source_rows=137,106, investable=True
- Locutorio [Servicios / Servicios al consumidor] -> epigrafes=1, source_rows=134,665, investable=True
- Fisioterapia [Salud y bienestar / Clinicas y consultas] -> epigrafes=2, source_rows=133,899, investable=True
- Comida preparada [Alimentacion / Comida preparada] -> epigrafes=2, source_rows=132,298, investable=True
- Aves y huevos [Alimentacion / Alimentacion fresca] -> epigrafes=2, source_rows=126,886, investable=True
- Pescaderia [Alimentacion / Alimentacion fresca] -> epigrafes=2, source_rows=124,980, investable=True
- Bar especial [Hosteleria / Bar y cafeteria] -> epigrafes=1, source_rows=123,978, investable=True
...
- Servicios profesionales [Servicios / Servicios profesionales] -> epigrafes=10, source_rows=93,858, investable=True
- Gimnasio [Deporte y ocio / Fitness y deporte] -> epigrafes=1, source_rows=91,750, investable=True
- Papeleria y prensa [Retail especializado / Cultura y ocio] -> epigrafes=1, source_rows=91,734, investable=True
- Telefonia [Retail especializado / Electronica y telecom] -> epigrafes=1, source_rows=89,568, investable=True
- Carniceria y charcuteria [Alimentacion / Alimentacion fresca] -> epigrafes=2, source_rows=87,149, investable=True
- Estanco [Retail especializado / Conveniencia] -> epigrafes=1, source_rows=85,824, investable=True
- Consulta medica [Salud y bienestar / Clinicas y consultas] -> epigrafes=2, source_rows=84,753, investable=True
- Lavanderia y tintoreria [Servicios / Servicios personales] -> epigrafes=1, source_rows=83,022, investable=True
- Taller chapa y pintura [Automocion / Taller y reparacion] -> epigrafes=1, source_rows=82,800, investable=True
- Arreglo de ropa [Servicios / Servicios personales] -> epigrafes=1, source_rows=81,801, investable=True
- Vivienda turistica [Alojamiento / Alojamiento turistico] -> epigrafes=1, source_rows=81,674, investable=True
- Optica [Salud y bienestar / Salud retail] -> epigrafes=1, source_rows=79,599, investable=True
- Textil hogar [Retail especializado / Hogar y decoracion] -> epigrafes=1, source_rows=79,320, investable=True
- Agencia de viajes [Servicios / Servicios al consumidor] -> epigrafes=1, source_rows=77,970, investable=True
- Arquitectura e ingenieria [Servicios / Servicios profesionales] -> epigrafes=2, source_rows=76,495, investable=True
...
- Publicidad y marketing [Servicios / Servicios profesionales] -> epigrafes=1, source_rows=46,021, investable=True
- Tienda multiproducto [Retail especializado / Conveniencia] -> epigrafes=1, source_rows=44,071, investable=True
