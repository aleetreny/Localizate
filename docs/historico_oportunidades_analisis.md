...
- frontend actual: `apps/web/components/map-shell.tsx`, `apps/web/components/opportunity-shell.tsx`, `apps/web/components/view-tabs.tsx`, `apps/web/components/madrid-map.tsx`, `apps/web/components/opportunity-map.tsx`
- contratos y carga de artefactos: `apps/web/lib/types.ts`, `apps/web/lib/public-data.ts`, `apps/web/lib/opportunity-insights.ts`
- builders y semantica de datos: `scripts/build_frontend_map_artifacts.py`, `scripts/build_frontend_opportunity_artifacts.py`
- base documental: `README.md`, `STATUS.md`, `docs/frontend_web_mvp.md`, `docs/external_datasets_report.md`, `docs/activity_taxonomy_web.md`
- senales de datos y modelado: `src/localizate/abt_survival.py`, `src/localizate/survival_features.py`
- cobertura de tests ya existente en Python: `tests/`, con especial foco en `tests/test_build_frontend_map_artifacts.py` y `tests/test_build_frontend_opportunity_artifacts.py`
...
- `apps/web/components/view-tabs.tsx`
- `apps/web/components/map-shell.tsx`
- `apps/web/components/opportunity-shell.tsx`
...
- `apps/web/components/map-shell.tsx`
- `apps/web/components/opportunity-shell.tsx`
- `apps/web/components/madrid-map.tsx`
- `apps/web/components/opportunity-map.tsx`
...
- `tests/` contiene bateria Python amplia
- `apps/web/package.json` no muestra scripts de test frontend
- no hay archivos `*.test.tsx` visibles en `apps/web`
...
Montar una CI minima con tres checks: unit tests Python, `tsc --noEmit` y `npm run build` en `apps/web`.
...
- `scripts/build_frontend_opportunity_artifacts.py`
- `scripts/build_frontend_map_artifacts.py`
...
- `apps/web/lib/public-data.ts`
- `STATUS.md` ya menciona la duda sobre migrar comparativas client-side a API ligera cuando crezca el payload
...
`STATUS.md` es una base excelente de contexto, pero no sustituye del todo a runbooks operativos cortos para reconstruir artefactos, validar resultados y depurar fallos.
