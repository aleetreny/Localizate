...
- Script generador: `back/scripts/build_frontend_map_artifacts.py`
- Salida principal:
...
- `storage/data/features/activity_survival_abt.csv`
- `storage/data/exports/activity_survival_map_export.csv`
- `storage/data/exports/district_category_survival.csv`
- `storage/data/exports/barrio_category_survival.csv`

Y produce:

- agregados por hexagono H3 y categoria
- opciones de selector
- fichas resumidas de categoria apoyadas en `docs/reference/ACTIVITY_GLOSSARY.md`
