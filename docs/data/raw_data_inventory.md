...
Inventario generado automaticamente a partir del contenido actual de `storage/raw/`.
...
- `padrón` tiene 104 periodos resueltos por preferencia de formato; se escoge la variante `csv` y se deja `txt` como respaldo.
...
No quedan incidencias abiertas en el manifiesto canónico actual.
