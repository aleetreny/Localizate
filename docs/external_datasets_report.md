...
**Ubicación archivos procesados:** `data/external/processed/`  
**Ubicación archivos raw:** `data/external/`
...
- `scripts/download_external_datasets.py` — Descarga los 29 archivos desde datos.madrid.es
- `scripts/transform_external_datasets.py` — Transforma raw → CSVs estandarizados en `data/external/processed/`
